...
/// Where a flag's `effectiveValue` (as returned by `SheepitClient.inspect`) came
...
public enum SheepitFlagValueSource: String, Sendable, CaseIterable {
    /// A local debug override is active (`SheepitClient.overrideFlag`).
    case override
...
/// Result of `SheepitClient.inspect(_:default:)` — a non-exposing diagnostic
