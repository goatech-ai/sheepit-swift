...
final class GTFlagManager: @unchecked Sendable {
    ...
    /// and never changed again — see `Sheepit.init`. `overrideFlag` (the
    ...
    /// `Sheepit.destroy()`. Without this, a consumer whose lifetime isn't
