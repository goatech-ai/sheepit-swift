...
/// `import SheepitSDK` at the top of this file is the whole mechanism.
...
/// `import SheepitSDK` — these assertions are meaningless under
...
final class GoaTechPrefixAliasTests: XCTestCase {
    func testGoaTechNamesTheSameClassAsSheepit() {
        XCTAssertTrue(GoaTech.self === Sheepit.self)
    }
    ...
    func testTheStaticFactorySurfaceWorksThroughTheAlias() {
        ...
        XCTAssertTrue(type(of: sdk) === Sheepit.self)
        sdk.destroy()
    }
}
