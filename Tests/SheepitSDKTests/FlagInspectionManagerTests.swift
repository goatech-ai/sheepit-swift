...
/// `GTFlagManager`-level tests for `inspect`, `knownFlagKeys`, per-key
...
final class FlagInspectionManagerTests: XCTestCase {
    // Raw UserDefaults.standard key GTFlagManager persists overrides
    ...
    func testClearOverridePurgesDiskEvenWhenOverridesAreDisabled() {
        ...
        let productionInstance = GTFlagManager()
